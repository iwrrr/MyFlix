package id.hwaryun.shared.data.local.datastore
...
interface UserPreferenceDataSource {
    ...
    suspend fun setUserLoggedStatus(isUserLoggedIn: Boolean)
...
class UserPreferenceDataSourceImpl(
    ...
    override suspend fun setUserLoggedStatus(isUserLoggedIn: Boolean) {
        dataStore.edit {
